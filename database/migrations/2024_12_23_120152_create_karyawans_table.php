...
class CreateKaryawansTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('Karyawan', function (Blueprint $table) {
            ...
            $table->boolean('karyawan_is_perusahaan')->nullable()->default(1);
            $table->string('karyawan_foto')->nullable();
            $table->text('karyawan_digital_signature')->nullable();
            $table->boolean('karyawan_is_deleted')->default(0);
            $table->boolean('karyawan_is_aktif')->default(1);
            $table->boolean('karyawan_is_dewa')->default(0);
            ...
            $table->decimal('karyawan_basic_salary', 30, 4)->nullable();
            $table->decimal('karyawan_basic_bpjs', 30, 4)->nullable();
            ...
            $table->decimal('karyawan_beginning_netto', 30, 4)->nullable();
            $table->decimal('karyawan_pph21paid', 30, 4)->nullable();
            ...
            $table->boolean('karyawan_is_resign')->default(0);
